...
describe('hook decorators', () => {
    describe('@BeforeCreateOne', () => {
        it('should store the hook', () => {
            ...
            const Stored = (0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_CREATE_ONE, Test);
        ...
        it('should return the hook class', () => {
            ...
            expect((0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_CREATE_ONE, Test)).toBe(MockHook);
        });
    });
    describe('@BeforeCreateMany', () => {
        it('should store the hook', () => {
            ...
            const Stored = (0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_CREATE_MANY, Test);
            expect(new Stored().run).toBe(hookFn);
        });
        it('should return a hook from the base class', () => {
            const hookFn = jest.fn();
        ...
        it('should return the hook class', () => {
            ...
            expect((0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_CREATE_MANY, Test)).toBe(MockHook);
        });
    });
    describe('@BeforeUpdateOne', () => {
        it('should store the hook', () => {
            ...
            const Stored = (0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_UPDATE_ONE, Test);
            expect(new Stored().run).toBe(hookFn);
        });
        it('should return a hook from the base class', () => {
            const hookFn = jest.fn();
        ...
        it('should return the hook class', () => {
            ...
            expect((0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_UPDATE_ONE, Test)).toBe(MockHook);
        });
    });
    describe('@BeforeUpdateMany', () => {
        it('should store the hook', () => {
            ...
            const Stored = (0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_UPDATE_MANY, Test);
            expect(new Stored().run).toBe(hookFn);
        });
        it('should return a hook from the base class', () => {
            const hookFn = jest.fn();
        ...
        it('should return the hook class', () => {
            ...
            expect((0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_UPDATE_MANY, Test)).toBe(MockHook);
        });
    });
    describe('@BeforeDeleteOne', () => {
        it('should store the hook', () => {
            ...
            const Stored = (0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_DELETE_ONE, Test);
            expect(new Stored().run).toBe(hookFn);
        });
        it('should return a hook from the base class', () => {
            const hookFn = jest.fn();
        ...
        it('should return the hook class', () => {
            ...
            expect((0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_DELETE_ONE, Test)).toBe(MockHook);
        });
    });
    describe('@BeforeDeleteMany', () => {
        it('should store the hook', () => {
            ...
            const Stored = (0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_DELETE_MANY, Test);
            expect(new Stored().run).toBe(hookFn);
        });
        it('should return a hook from the base class', () => {
            const hookFn = jest.fn();
        ...
        it('should return the hook class', () => {
            ...
            expect((0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_DELETE_MANY, Test)).toBe(MockHook);
        });
    });
    describe('@BeforeQueryMany', () => {
        it('should store the hook', () => {
            ...
            const Stored = (0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_QUERY_MANY, Test);
            expect(new Stored().run).toBe(hookFn);
        });
        it('should return a hook from the base class', () => {
            const hookFn = jest.fn();
        ...
        it('should return the hook class', () => {
            ...
            expect((0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_QUERY_MANY, Test)).toBe(MockHook);
        });
    });
    describe('@BeforeFindOne', () => {
        it('should store the hook', () => {
            ...
            const Stored = (0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_FIND_ONE, Test);
            expect(new Stored().run).toBe(hookFn);
        });
        it('should return a hook from the base class', () => {
            const hookFn = jest.fn();
        ...
        it('should return the hook class', () => {
            ...
            expect((0, decorators_1.getHookForType)(hooks_1.HookTypes.BEFORE_FIND_ONE, Test)).toBe(MockHook);
        });
    });
});
